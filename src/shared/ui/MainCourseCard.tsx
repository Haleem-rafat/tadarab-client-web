...
export default function MainCourseCard({
  ...
  return (
    <div
      dir="rtl"
      className={`min-h-[350px] max-w-[335px] cursor-pointer overflow-hidden rounded-xl transition-transform ${className || ''}`}
      ...
      <div className="relative h-[180px] w-full overflow-hidden">
        {!imageError ? (
          ...
          <div className="flex h-[180px] w-full items-center justify-center bg-gray-800">
      ...
      <div className="bg-background-card flex h-full flex-col gap-2 px-5 pt-4 pb-5 text-white">
        ...
        <div className="text-input-placeholder flex items-center gap-2 gap-5">
          <div
